...
![alt text](../img/power_sw_v3_1.JPG)

はんだのランドとスイッチの足が合うように基板上に配置し、マスキングで仮止めします。   
（この写真はんだ汚いっすね、、、） 

![alt text](../img/power_sw_v3_2.JPG)
...
### 3-8．ロータリーエンコーダの組み立て  
> [!TIP]  
> ロータリーエンコーダはロープロファイル仕様にも変更可能です。  
> [こちら](https://github.com/kumamuk-git/CKW12/blob/main/doc/buildguide.md)ご参照ください
...
kotさんありがとうございます。  
[#36](https://github.com/kumamuk-git/zmk-config-roBa/pull/36)からデフォルトでroBa.keymapファイルにコメントアウトされた状態で矢印割り当てが記載されています。  
コメント解除することでこちらの機能を使うことができるようになりました。
...
+ 白湯さん（moNaの設計者）がトラブルシューティング用の[note](https://note.com/pooh_polo/n/n386f7c9355bc)を書いてくださいました！  キーなどが反応しない場合はまずこちら目を通して頂くと良いと思います！
